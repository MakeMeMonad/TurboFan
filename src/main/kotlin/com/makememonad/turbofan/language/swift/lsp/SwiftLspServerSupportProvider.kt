...
final class SwiftLspServerSupportProvider: LspServerSupportProvider {
	override fun fileOpened(project: Project, file: VirtualFile, serverStarter: LspServerSupportProvider.LspServerStarter) {
		...
		else {notifySourceKitNotFound(project)}
	}
	...
	fun notifySourceKitNotFound(project: Project? = null) {
		NotificationGroupManager.getInstance()
			...
			.createNotification(
				"Could not find SourceKit-LSP",
				"Please install the Swift toolchain or provide the path in settings.",
