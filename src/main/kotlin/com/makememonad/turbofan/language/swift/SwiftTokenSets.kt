...
object SwiftTokenSets {
    val ALL_IDENTIFIERS = TokenSet.create(IDENTIFIER)
    ...
    val ALL_OPERATORS = TokenSet.create(OPERATOR, DOT_OPERATOR, PREFIX_OPERATOR, INFIX_OPERATOR, POSTFIX_OPERATOR)
    // TODO: Figure out doc-string comments, get a rule in place for those and a token as well...
    val ALL_LITERALS = TokenSet.orSet(this.STRINGS, this.NUMBERS, this.COMMENTS, this.OTHER_LITERALS)
    ...
    val SINGLELINE_STRINGS = TokenSet.create(STRING_START, STRING_TEXT, STRING_END)
    ...
    val MULTILINE_COMMENTS = TokenSet.create(MULTILINE_COMMENT_START, MULTILINE_COMMENT_TEXT, MULTILINE_COMMENT_END)
