...
public class SwiftSetterKeywordClauseImplGen extends ASTWrapperPsiElement implements SwiftSetterKeywordClause {

  public SwiftSetterKeywordClauseImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitSetterKeywordClause(this);
  }
