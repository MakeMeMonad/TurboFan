...
public class SwiftStatementImplGen extends ASTWrapperPsiElement implements SwiftStatement {

  public SwiftStatementImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SwiftCompilerControlStatement getCompilerControlStatement() {
    return findChildByClass(SwiftCompilerControlStatement.class);
  }
  ...
  @Override
  @Nullable
  public SwiftControlTransferStatement getControlTransferStatement() {
    return findChildByClass(SwiftControlTransferStatement.class);
  }

  @Override
  @Nullable
  public SwiftDeclaration getDeclaration() {
    return findChildByClass(SwiftDeclaration.class);
  }

  @Override
  @Nullable
  public SwiftDeferStatement getDeferStatement() {
    return findChildByClass(SwiftDeferStatement.class);
  }
  ...
  @Override
  @Nullable
  public SwiftLabeledStatement getLabeledStatement() {
    return findChildByClass(SwiftLabeledStatement.class);
  }
  ...
  @Override
  @Nullable
  public PsiElement getKwGuard() {
    return findChildByType(KW_GUARD);
  }
