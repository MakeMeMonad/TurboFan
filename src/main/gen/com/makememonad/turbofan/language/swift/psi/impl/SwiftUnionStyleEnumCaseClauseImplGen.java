...
public class SwiftUnionStyleEnumCaseClauseImplGen extends ASTWrapperPsiElement implements SwiftUnionStyleEnumCaseClause {

  public SwiftUnionStyleEnumCaseClauseImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitUnionStyleEnumCaseClause(this);
  }
  ...
  @Override
  @NotNull
  public SwiftUnionStyleEnumCaseList getUnionStyleEnumCaseList() {
    return findNotNullChildByClass(SwiftUnionStyleEnumCaseList.class);
  }
