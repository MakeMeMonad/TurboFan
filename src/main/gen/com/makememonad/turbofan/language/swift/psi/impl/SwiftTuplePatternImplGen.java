...
public class SwiftTuplePatternImplGen extends ASTWrapperPsiElement implements SwiftTuplePattern {

  public SwiftTuplePatternImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SwiftTuplePatternElementList getTuplePatternElementList() {
    return findChildByClass(SwiftTuplePatternElementList.class);
  }
