...
public class SwiftParameterListImplGen extends ASTWrapperPsiElement implements SwiftParameterList {

  public SwiftParameterListImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SwiftParameter> getParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwiftParameter.class);
  }
