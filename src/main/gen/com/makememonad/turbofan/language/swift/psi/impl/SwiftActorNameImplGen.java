...
public class SwiftActorNameImplGen extends ASTWrapperPsiElement implements SwiftActorName {

  public SwiftActorNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitActorName(this);
  }
