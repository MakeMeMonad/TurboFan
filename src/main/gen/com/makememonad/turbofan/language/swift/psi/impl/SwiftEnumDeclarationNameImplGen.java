...
public class SwiftEnumDeclarationNameImplGen extends ASTWrapperPsiElement implements SwiftEnumDeclarationName {

  public SwiftEnumDeclarationNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitEnumDeclarationName(this);
  }
