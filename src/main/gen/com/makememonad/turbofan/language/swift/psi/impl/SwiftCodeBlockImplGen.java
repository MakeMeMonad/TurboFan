...
public class SwiftCodeBlockImplGen extends ASTWrapperPsiElement implements SwiftCodeBlock {

  public SwiftCodeBlockImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SwiftStatements getStatements() {
    return findChildByClass(SwiftStatements.class);
  }
