...
public class SwiftActorDeclarationImplGen extends ASTWrapperPsiElement implements SwiftActorDeclaration {

  public SwiftActorDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SwiftActorName getActorName() {
    return findNotNullChildByClass(SwiftActorName.class);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwActor() {
    return findNotNullChildByType(KW_ACTOR);
  }
