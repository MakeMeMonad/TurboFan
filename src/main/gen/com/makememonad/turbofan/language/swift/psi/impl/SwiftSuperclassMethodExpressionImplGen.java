...
public class SwiftSuperclassMethodExpressionImplGen extends ASTWrapperPsiElement implements SwiftSuperclassMethodExpression {

  public SwiftSuperclassMethodExpressionImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitSuperclassMethodExpression(this);
  }
  ...
  public PsiElement getKwSuper() {
    return findNotNullChildByType(KW_SUPER);
  }
