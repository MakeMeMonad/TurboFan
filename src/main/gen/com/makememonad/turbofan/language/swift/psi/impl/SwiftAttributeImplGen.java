...
public class SwiftAttributeImplGen extends ASTWrapperPsiElement implements SwiftAttribute {

  public SwiftAttributeImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SwiftAttributeName getAttributeName() {
    return findNotNullChildByClass(SwiftAttributeName.class);
  }
