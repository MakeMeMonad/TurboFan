...
public class SwiftAttributeNameImplGen extends ASTWrapperPsiElement implements SwiftAttributeName {

  public SwiftAttributeNameImplGen(@NotNull ASTNode node) {
    super(node);
  }
