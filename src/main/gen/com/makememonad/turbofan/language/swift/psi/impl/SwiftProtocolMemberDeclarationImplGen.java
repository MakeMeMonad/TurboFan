...
public class SwiftProtocolMemberDeclarationImplGen extends ASTWrapperPsiElement implements SwiftProtocolMemberDeclaration {

  public SwiftProtocolMemberDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitProtocolMemberDeclaration(this);
  }
  ...
  @Override
  @Nullable
  public SwiftFunctionDeclarationName getFunctionDeclarationName() {
    return findChildByClass(SwiftFunctionDeclarationName.class);
  }
  ...
  public SwiftParameterClause getParameterClause() {
    return findChildByClass(SwiftParameterClause.class);
  }

  @Override
  @Nullable
  public SwiftProtocolAssociatedTypeDeclaration getProtocolAssociatedTypeDeclaration() {
    return findChildByClass(SwiftProtocolAssociatedTypeDeclaration.class);
  }
  ...
  @Override
  @Nullable
  public SwiftProtocolVariableDeclaration getProtocolVariableDeclaration() {
    return findChildByClass(SwiftProtocolVariableDeclaration.class);
  }
  ...
  public PsiElement getKwSubscript() {
    return findChildByType(KW_SUBSCRIPT);
  }
