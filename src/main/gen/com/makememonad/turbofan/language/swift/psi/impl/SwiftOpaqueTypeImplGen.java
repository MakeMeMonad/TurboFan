...
public class SwiftOpaqueTypeImplGen extends ASTWrapperPsiElement implements SwiftOpaqueType {

  public SwiftOpaqueTypeImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwSome() {
    return findNotNullChildByType(KW_SOME);
  }
