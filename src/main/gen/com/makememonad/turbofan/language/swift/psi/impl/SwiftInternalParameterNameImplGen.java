...
public class SwiftInternalParameterNameImplGen extends ASTWrapperPsiElement implements SwiftInternalParameterName {

  public SwiftInternalParameterNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitInternalParameterName(this);
  }
