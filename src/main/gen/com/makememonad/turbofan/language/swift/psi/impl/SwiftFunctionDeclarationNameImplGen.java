...
public class SwiftFunctionDeclarationNameImplGen extends ASTWrapperPsiElement implements SwiftFunctionDeclarationName {

  public SwiftFunctionDeclarationNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitFunctionDeclarationName(this);
  }
