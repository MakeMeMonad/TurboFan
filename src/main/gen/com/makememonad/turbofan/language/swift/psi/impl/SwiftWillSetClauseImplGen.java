...
public class SwiftWillSetClauseImplGen extends ASTWrapperPsiElement implements SwiftWillSetClause {

  public SwiftWillSetClauseImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitWillSetClause(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwWillset() {
    return findNotNullChildByType(KW_WILLSET);
  }
