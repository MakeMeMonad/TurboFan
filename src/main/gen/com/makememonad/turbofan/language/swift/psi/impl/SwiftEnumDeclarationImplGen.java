...
public class SwiftEnumDeclarationImplGen extends ASTWrapperPsiElement implements SwiftEnumDeclaration {

  public SwiftEnumDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SwiftRawValueStyleEnum getRawValueStyleEnum() {
    return findChildByClass(SwiftRawValueStyleEnum.class);
  }

  @Override
  @Nullable
  public SwiftUnionStyleEnum getUnionStyleEnum() {
    return findChildByClass(SwiftUnionStyleEnum.class);
  }
