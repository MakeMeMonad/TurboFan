...
public class SwiftConstantDeclarationImplGen extends ASTWrapperPsiElement implements SwiftConstantDeclaration {

  public SwiftConstantDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SwiftPatternInitializerList getPatternInitializerList() {
    return findNotNullChildByClass(SwiftPatternInitializerList.class);
  }

  @Override
  @NotNull
  public PsiElement getKwLet() {
    return findNotNullChildByType(KW_LET);
  }

  @Override
  public @NotNull List<@NotNull String> getDeclaredNames() {
    return SwiftPsiImplUtil.getDeclaredNames(this);
  }
