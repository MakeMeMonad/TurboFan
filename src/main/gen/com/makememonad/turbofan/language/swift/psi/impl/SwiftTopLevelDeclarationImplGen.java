...
public class SwiftTopLevelDeclarationImplGen extends ASTWrapperPsiElement implements SwiftTopLevelDeclaration {

  public SwiftTopLevelDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SwiftStatements getStatements() {
    return findNotNullChildByClass(SwiftStatements.class);
  }
