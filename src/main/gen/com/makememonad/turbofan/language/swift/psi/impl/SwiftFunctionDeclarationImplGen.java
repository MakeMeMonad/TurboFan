...
public class SwiftFunctionDeclarationImplGen extends ASTWrapperPsiElement implements SwiftFunctionDeclaration {

  public SwiftFunctionDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SwiftFunctionDeclarationName getFunctionDeclarationName() {
    return findNotNullChildByClass(SwiftFunctionDeclarationName.class);
  }
  ...
  public PsiElement getKwFunc() {
    return findNotNullChildByType(KW_FUNC);
  }
