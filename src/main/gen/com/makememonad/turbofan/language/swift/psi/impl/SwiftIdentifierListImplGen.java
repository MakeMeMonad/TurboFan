...
public class SwiftIdentifierListImplGen extends ASTWrapperPsiElement implements SwiftIdentifierList {

  public SwiftIdentifierListImplGen(@NotNull ASTNode node) {
    super(node);
  }
