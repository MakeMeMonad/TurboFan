...
public class SwiftGenericParameterListImplGen extends ASTWrapperPsiElement implements SwiftGenericParameterList {

  public SwiftGenericParameterListImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SwiftGenericParameter> getGenericParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwiftGenericParameter.class);
  }
