...
public class SwiftFunctionTypeArgumentNameImplGen extends ASTWrapperPsiElement implements SwiftFunctionTypeArgumentName {

  public SwiftFunctionTypeArgumentNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitFunctionTypeArgumentName(this);
  }
