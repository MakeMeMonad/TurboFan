...
public class SwiftExternalParameterNameImplGen extends ASTWrapperPsiElement implements SwiftExternalParameterName {

  public SwiftExternalParameterNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitExternalParameterName(this);
  }
