...
public class SwiftMiscWrappedIdentifierTokenImplGen extends ASTWrapperPsiElement implements SwiftMiscWrappedIdentifierToken {

  public SwiftMiscWrappedIdentifierTokenImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitMiscWrappedIdentifierToken(this);
  }
