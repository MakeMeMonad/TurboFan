...
public class SwiftPrecedenceGroupNameImplGen extends ASTWrapperPsiElement implements SwiftPrecedenceGroupName {

  public SwiftPrecedenceGroupNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitPrecedenceGroupName(this);
  }
