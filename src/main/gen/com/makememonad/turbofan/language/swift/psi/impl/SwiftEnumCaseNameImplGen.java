...
public class SwiftEnumCaseNameImplGen extends ASTWrapperPsiElement implements SwiftEnumCaseName {

  public SwiftEnumCaseNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitEnumCaseName(this);
  }
