...
public class SwiftBoxedProtocolTypeImplGen extends ASTWrapperPsiElement implements SwiftBoxedProtocolType {

  public SwiftBoxedProtocolTypeImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitBoxedProtocolType(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwLowerAny() {
    return findNotNullChildByType(KW_LOWER_ANY);
  }
