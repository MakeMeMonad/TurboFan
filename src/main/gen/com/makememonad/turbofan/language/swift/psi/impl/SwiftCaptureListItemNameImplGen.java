...
public class SwiftCaptureListItemNameImplGen extends ASTWrapperPsiElement implements SwiftCaptureListItemName {

  public SwiftCaptureListItemNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitCaptureListItemName(this);
  }
