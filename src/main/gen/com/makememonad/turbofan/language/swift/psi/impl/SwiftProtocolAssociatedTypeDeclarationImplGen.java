...
public class SwiftProtocolAssociatedTypeDeclarationImplGen extends ASTWrapperPsiElement implements SwiftProtocolAssociatedTypeDeclaration {

  public SwiftProtocolAssociatedTypeDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitProtocolAssociatedTypeDeclaration(this);
  }
  ...
  public SwiftTypealiasAssignment getTypealiasAssignment() {
    return findChildByClass(SwiftTypealiasAssignment.class);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwAssociatedtype() {
    return findNotNullChildByType(KW_ASSOCIATEDTYPE);
  }
