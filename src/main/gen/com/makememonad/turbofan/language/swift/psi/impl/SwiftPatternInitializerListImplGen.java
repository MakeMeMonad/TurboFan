...
public class SwiftPatternInitializerListImplGen extends ASTWrapperPsiElement implements SwiftPatternInitializerList {

  public SwiftPatternInitializerListImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitPatternInitializerList(this);
  }
