...
public class SwiftMacroExpansionExpressionNameImplGen extends ASTWrapperPsiElement implements SwiftMacroExpansionExpressionName {

  public SwiftMacroExpansionExpressionNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitMacroExpansionExpressionName(this);
  }
