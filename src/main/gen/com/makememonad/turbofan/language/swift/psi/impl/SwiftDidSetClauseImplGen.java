...
public class SwiftDidSetClauseImplGen extends ASTWrapperPsiElement implements SwiftDidSetClause {

  public SwiftDidSetClauseImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitDidSetClause(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwDidset() {
    return findNotNullChildByType(KW_DIDSET);
  }
