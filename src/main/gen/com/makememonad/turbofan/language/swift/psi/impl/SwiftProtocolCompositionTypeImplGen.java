...
public class SwiftProtocolCompositionTypeImplGen extends ASTWrapperPsiElement implements SwiftProtocolCompositionType {

  public SwiftProtocolCompositionTypeImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitProtocolCompositionType(this);
  }
