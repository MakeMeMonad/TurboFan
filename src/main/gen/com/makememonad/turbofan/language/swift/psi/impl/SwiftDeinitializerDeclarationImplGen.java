...
public class SwiftDeinitializerDeclarationImplGen extends ASTWrapperPsiElement implements SwiftDeinitializerDeclaration {

  public SwiftDeinitializerDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitDeinitializerDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwDeinit() {
    return findNotNullChildByType(KW_DEINIT);
  }

  @Override
  @NotNull
  public PsiElement getMethods() {
    return findNotNullChildByType(METHODS);
  }
