...
public class SwiftTypealiasNameImplGen extends ASTWrapperPsiElement implements SwiftTypealiasName {

  public SwiftTypealiasNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitTypealiasName(this);
  }
