...
public class SwiftProtocolDeclarationImplGen extends ASTWrapperPsiElement implements SwiftProtocolDeclaration {

  public SwiftProtocolDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SwiftProtocolMemberDeclaration> getProtocolMemberDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwiftProtocolMemberDeclaration.class);
  }

  @Override
  @NotNull
  public SwiftProtocolName getProtocolName() {
    return findNotNullChildByClass(SwiftProtocolName.class);
  }
  ...
  public PsiElement getKwLowerProtocolDecl() {
    return findNotNullChildByType(KW_LOWER_PROTOCOL_DECL);
  }
