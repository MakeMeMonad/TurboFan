...
public class SwiftClosureParameterNameImplGen extends ASTWrapperPsiElement implements SwiftClosureParameterName {

  public SwiftClosureParameterNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitClosureParameterName(this);
  }
