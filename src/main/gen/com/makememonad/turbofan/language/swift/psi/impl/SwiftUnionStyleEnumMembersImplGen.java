...
public class SwiftUnionStyleEnumMembersImplGen extends ASTWrapperPsiElement implements SwiftUnionStyleEnumMembers {

  public SwiftUnionStyleEnumMembersImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitUnionStyleEnumMembers(this);
  }
  ...
  @Override
  @NotNull
  public List<SwiftUnionStyleEnumCaseClause> getUnionStyleEnumCaseClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwiftUnionStyleEnumCaseClause.class);
  }
