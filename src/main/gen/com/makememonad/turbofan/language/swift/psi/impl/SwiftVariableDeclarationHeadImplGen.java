...
public class SwiftVariableDeclarationHeadImplGen extends ASTWrapperPsiElement implements SwiftVariableDeclarationHead {

  public SwiftVariableDeclarationHeadImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitVariableDeclarationHead(this);
  }
  ...
  public PsiElement getKwVar() {
    return findNotNullChildByType(KW_VAR);
  }
