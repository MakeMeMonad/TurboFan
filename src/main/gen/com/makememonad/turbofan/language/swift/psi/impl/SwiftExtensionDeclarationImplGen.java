...
public class SwiftExtensionDeclarationImplGen extends ASTWrapperPsiElement implements SwiftExtensionDeclaration {

  public SwiftExtensionDeclarationImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwExtension() {
    return findNotNullChildByType(KW_EXTENSION);
  }
