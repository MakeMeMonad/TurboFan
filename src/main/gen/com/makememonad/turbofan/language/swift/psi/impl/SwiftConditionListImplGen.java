...
public class SwiftConditionListImplGen extends ASTWrapperPsiElement implements SwiftConditionList {

  public SwiftConditionListImplGen(@NotNull ASTNode node) {
    super(node);
  }
