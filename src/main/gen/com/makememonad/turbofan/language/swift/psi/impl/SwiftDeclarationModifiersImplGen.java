...
public class SwiftDeclarationModifiersImplGen extends ASTWrapperPsiElement implements SwiftDeclarationModifiers {

  public SwiftDeclarationModifiersImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitDeclarationModifiers(this);
  }
