...
public class SwiftGetterKeywordClauseImplGen extends ASTWrapperPsiElement implements SwiftGetterKeywordClause {

  public SwiftGetterKeywordClauseImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitGetterKeywordClause(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKwGet() {
    return findNotNullChildByType(KW_GET);
  }
