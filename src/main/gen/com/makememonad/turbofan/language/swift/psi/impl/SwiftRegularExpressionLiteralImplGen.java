...
public class SwiftRegularExpressionLiteralImplGen extends ASTWrapperPsiElement implements SwiftRegularExpressionLiteral {

  public SwiftRegularExpressionLiteralImplGen(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getRegexpLiteral() {
    return findNotNullChildByType(REGEXP_LITERAL);
  }
