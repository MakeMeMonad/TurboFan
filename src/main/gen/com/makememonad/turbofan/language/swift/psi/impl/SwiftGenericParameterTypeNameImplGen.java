...
public class SwiftGenericParameterTypeNameImplGen extends ASTWrapperPsiElement implements SwiftGenericParameterTypeName {

  public SwiftGenericParameterTypeNameImplGen(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SwiftVisitor visitor) {
    visitor.visitGenericParameterTypeName(this);
  }
