...
<YYINITIAL> {
	...
	("//" {comTextItem}+ {LineTerm}?) {return SINGLELINE_COMMENT;}

		// RULE: QUOTED/PRIVATE-USE IDENTIFIERS
	"`" {IdentifierHead}{IdentifierCharacter}* "`" {return QUOTED_IDENTIFIER;}
	...
	"0"[xX] (({HexDigitsWithUnderscores})? {HexFraction} | {HexDigitsWithUnderscores}) {HexExponent} {return HEX_FLOATING_POINT_LITERAL;}
	...
	{DecimalDigitsWithUnderscores} ( {DecimalFraction} ({DecimalExponent})? | {DecimalExponent} ) {return DECIMAL_FLOATING_POINT_LITERAL;}
	...
	"0"[bB]{BinaryBody} {return BINARY_LITERAL;}
	"0"[oO]{OctalBody} {return OCTAL_LITERAL;}
	"0"[xX]{HexBody} {return HEX_LITERAL;}
	{DecimalBody} {return DECIMAL_LITERAL;}
	...
	"\$"{DecimalDigit}+ {return IMPLICIT_PARAMETER_NAME;}
	"\$"{IdentifierHead}{IdentifierCharacter}* {return PROPERTY_WRAPPER_PROJECTION;}
	...
	{OperatorHead} {OperatorCharacter}* {return OPERATOR;}
	{IdentifierHead}{IdentifierCharacter}* {return IDENTIFIER;}
...
<STRING> {
	...
	\\ {AnyEscapedCharacterPattern} {return STRING_ESCAPED_SEQUENCE;}
	[\u000A\u000D] {return BAD_CHARACTER;}
	{QuotedTextItemPattern_SingleLine}+ {return STRING_TEXT;}
...
<MULTILINE_STRING> {
	...
	"/*" {
		...
		// RULES: ESCAPE SEQs
	{EscapedNewlinePattern} {return MULTILINE_STRING_ESCAPED_NEWLINE;}
	\\{AnyEscapedCharacterPattern} {return MULTILINE_STRING_ESCAPED_SEQUENCE;}
